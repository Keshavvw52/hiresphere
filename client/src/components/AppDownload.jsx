        ...
        >
          ...
          <div className="relative z-10">
            ...
            >
              <a
                href="#jobs-section"
                className="px-8 py-4 bg-purple-600 hover:bg-pink-600 text-white font-medium rounded-lg shadow-md transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 text-center"
              >
                Browse Jobs
              </a>
