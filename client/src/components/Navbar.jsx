    ...
    <>
      ...
      <div className={`${scrolled ? "fixed animate-slideDown" : "relative"} top-0 left-0 right-0 z-20 w-full transition-all duration-300`}>
        <nav className={`transition-all duration-500 ${
          ...
          >
            <div className={`bg-gradient-to-br from-purple-600 to-pink-600 p-2 rounded-lg ${scrolled ? 'shadow-lg' : ''} group-hover:shadow-blue-500/30 transition-all duration-300`}>
              <Zap size={24} className="text-white" />
            </div>
            <span className="text-2xl font-bold bg-gradient-to-r from-purple-600 via-pink-500 to-rose-500 bg-clip-text text-transparent">
              HireSphere
            </span>
          </div>
            ...
            {user ? (
              ...
              <>
                ...
                <button
                  ...
                  className={`bg-gradient-to-r from-purple-600 to-pink-600 hover:from-blue-700 hover:to-indigo-800 text-white px-6 py-2.5 rounded-xl font-medium text-sm ${scrolled ? 'shadow-lg hover:shadow-blue-500/30' : 'hover:shadow-md'} transition-all duration-300`}
                >
                  Get Started
                </button>
              </>
